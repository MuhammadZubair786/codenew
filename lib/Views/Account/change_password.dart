                    ...
                    child: TextFormField(
                      ...
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                          return "تکایە وشەی نهێنی بنوسە";
                        }
                        if (value.length < 8) {
                          return "وشەی نهێنی دەبێت لانی کەم ٨ پیت بێت";
                        }
                        return null;
                      },
                    ),
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: "دوبارە کردنەوەی وشەی نهێنی",
                        hintStyle: TextStyle(
                            color: Color(0xff8E99B7), fontSize: hintFontSize),
                        suffixIcon: GestureDetector(
                          behavior: HitTestBehavior.translucent,
                      ...
                      validator: (value) {
                        ...
                        if (value != controller.newPassword.text) {
                          return "وشەی نهێنی دووبارە وەک یەک نین";
                        }
                        return null;
                      },
                    ),
