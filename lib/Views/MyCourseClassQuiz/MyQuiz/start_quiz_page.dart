              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      "پرۆسێسکردنی ئەنجامی کویز. تكایه‌ چاوه‌ڕێبه",
                      style:
    ...
    return GetBuilder<QuestionController>(
      ...
      builder: (controller) {
        ...
        return Column(
          ...
          children: [
            Text("$remainingTime" + " " + "دەقە"),
            controller.quiz.value.questionTimeType == 1
                ? Text("جێهێشت بۆ کویزەکە")
                : Text("بۆ ئەم بەشە جێهێڵراوە"),
          ],
        );
      },
    );
