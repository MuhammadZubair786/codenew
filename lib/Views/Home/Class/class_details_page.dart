...
final ClassController controller = Get.put(ClassController());
 ...
 @override
  void initState(){
    super.initState();
    print(controller.allClass.length);
  }
  ...
  Widget scheduleWidget(
    ...
    Future<String> addToCart(String courseID) async {
      ...
      if (response.statusCode == 200) {
        ...
        // controller.courseID.value = controller.classDetails.value.id;
        controller.getClassDetails();
        return message;
      } else {
        //show error message
        return "هەڵەیەک رویدا";
      }
    }
      ...
      Scaffold(
        ...
        floatingActionButton: dashboardController.loggedIn.value
            ...
            : ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(primary: Color(0xFFD7598F)),
                child: Container(
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          controller.classDetails.value.user.shortDetails !=null ?
                          courseStructure(
